...
function main() {
  ...
  for(i = 0; i < 3; i++){
    ...
    gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(model[i].vertices), gl.STATIC_DRAW);
    ...
    //if(i == 0){
        ...
        gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(model[i].normals), gl.STATIC_DRAW);
...
async function init(){
  ...
  await utils.loadFiles([shaderDir + 'vs_lamb.glsl', shaderDir + 'fs_lamb.glsl'], function (shaderText) {
    ...
    var Cube00_B = await utils.get_objstr("assets/Cube00_B.obj");
    model[0] = new OBJ.Mesh(Cube00_B);
    var Cube00_M = await utils.get_objstr("assets/Cube00_M.obj");
    model[1] = new OBJ.Mesh(Cube00_M);
    var Cube00 = await utils.get_objstr("assets/Cube00.obj");
    model[2] = new OBJ.Mesh(Cube00);
    /*var Cube00_B = await utils.get_objstr("assets/Cube00_B");
    model[3] = new OBJ.Mesh(Cube01_B);
    var Cube00_B = await utils.get_objstr("assets/Cube00_B");
    model[4] = new OBJ.Mesh(Cube01_M);
    var Cube00_B = await utils.get_objstr("assets/Cube00_B");
    model[5] = new OBJ.Mesh(Cube01);
    var Cube00_B = await utils.get_objstr("assets/Cube00_B");
    model[6] = new OBJ.Mesh(Cube02_B);
    var Cube00_B = await utils.get_objstr("assets/Cube00_B");
    model[7] = new OBJ.Mesh(Cube02_M);
    var Cube00_B = await utils.get_objstr("assets/Cube00_B");
    model[8] = new OBJ.Mesh(Cube02);
    var Cube00_B = await utils.get_objstr("assets/Cube00_B");
    model[9] = new OBJ.Mesh(Cube10_B);
    var Cube00_B = await utils.get_objstr("assets/Cube00_B");
    model[10] = new OBJ.Mesh(Cube10_M);
    var Cube00_B = await utils.get_objstr("assets/Cube00_B");
    model[11] = new OBJ.Mesh(Cube10);
    var Cube00_B = await utils.get_objstr("assets/Cube00_B");
    model[12] = new OBJ.Mesh(Cube11_B);
    var Cube00_B = await utils.get_objstr("assets/Cube00_B");
    model[14] = new OBJ.Mesh(Cube11);
    var Cube00_B = await utils.get_objstr("assets/Cube00_B");
    model[15] = new OBJ.Mesh(Cube12_B);
    var Cube00_B = await utils.get_objstr("assets/Cube00_B");
    model[16] = new OBJ.Mesh(Cube12_M);
    var Cube00_B = await utils.get_objstr("assets/Cube00_B");
    model[17] = new OBJ.Mesh(Cube12);
    var Cube00_B = await utils.get_objstr("assets/Cube00_B");
    model[18] = new OBJ.Mesh(Cube20_B);
    var Cube00_B = await utils.get_objstr("assets/Cube00_B");
    model[19] = new OBJ.Mesh(Cube20_M);
    var Cube00_B = await utils.get_objstr("assets/Cube00_B");
    model[20] = new OBJ.Mesh(Cube20);
    var Cube00_B = await utils.get_objstr("assets/Cube00_B");
    model[21] = new OBJ.Mesh(Cube21_B);
    var Cube00_B = await utils.get_objstr("assets/Cube00_B");
    model[22] = new OBJ.Mesh(Cube21_M);
    var Cube00_B = await utils.get_objstr("assets/Cube00_B");
    model[23] = new OBJ.Mesh(Cube21);
    var Cube00_B = await utils.get_objstr("assets/Cube00_B");
    model[24] = new OBJ.Mesh(Cube22_B);
    var Cube00_B = await utils.get_objstr("assets/Cube00_B");
    model[25] = new OBJ.Mesh(Cube22_M);
    var Cube00_B = await utils.get_objstr("assets/Cube00_B");
    model[26] = new OBJ.Mesh(Cube22);*/
